...
printf "\033[96m'git pull' the latest examples in ~/memryx_examples and rebuild apps?\033[0m " gitcheck
...
if [[ $gitcheck == "Y" ]] || [[ $gitcheck == "y" ]]; then
  ...
  # DepthEstimation
  cd /home/memryx/memryx_examples/video_inference/depth_midas/src/cpp/build/ && make

  # YOLOv8m Segmentation
  cd /home/memryx/memryx_examples/video_inference/segmentation_yolov8/src/cpp/build/ && make
  
  # YOLOv9s Video Obj. Det.
  cd /home/memryx/memryx_examples/multistream_video_inference/object_detection_yolov8/src/cpp/build/ && make
